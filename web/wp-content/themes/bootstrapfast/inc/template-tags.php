...
if ( ! function_exists( 'bootstrapfast_posted_on' ) ) {
	/**
	 * Prints HTML with meta information for the current post-date/time and author.
	 */
	function bootstrapfast_posted_on() {
...
if ( ! function_exists( 'bootstrapfast_entry_footer' ) ) {
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function bootstrapfast_entry_footer() {
...
function bootstrapfast_categorized_blog() {
	...
	if ( false === $all_the_cool_cats ) {
		...
		set_transient( 'bootstrapfast_categories', $all_the_cool_cats );
	}

	if ( $all_the_cool_cats > 1 ) {
		// This blog has more than 1 category so bootstrapfast_categorized_blog should return true.
		return true;
	} else {
		// This blog has only 1 category so bootstrapfast_categorized_blog should return false.
		return false;
	}
}

/**
 * Flush out the transients used in bootstrapfast_categorized_blog.
 */
function bootstrapfast_category_transient_flusher() {
